...
<%
	...
	AlertGroup group = analysis.getPega05ById(alertGroupLabel);
%>
<script>
$(function() {
...
#individualAlerts{float:right;padding:10px;margin-right:100px;width:300px;}
.titletoggle
{
	cursor: pointer;
...
<div id="summary" class="ui-widget-content">
	...
	<br><b>STDDEV: </b><%=group.getStdDev() %><br/>
		<b>	<%
	...
	%></b><br/>
	<br><b>SQL:</b><br/>
	<textarea cols=70 rows=12 id="rawsql"><%=AlertAnalysis.parse05Line(group.getAlerts().get(0).getLine()) %></textarea>
	<br/><br/>
	<a id="sqllabel" href="javascript:fmtSql();">View Formatted SQL</a>
	<div id="fmtsql" style="display:none;">
	<br><b>Formatted SQL:</b><br/>
	<pre><%=StringUtil.sqlFmt(AlertAnalysis.parse05Line(group.getAlerts().get(0).getLine())).trim() %></pre>
	</div>
